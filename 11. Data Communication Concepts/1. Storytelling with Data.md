...
# 📘 Narrative structure
<img src="https://user-images.githubusercontent.com/51888893/209674978-d9cac1d8-b702-4931-a6a6-6f593ee36ba8.png" width=700px>

- `background` : ***total profic decreased***
  - what `motived` the analysis ?
  - what `changed` ?
  - who is the `focus` of the analysis ?
    - customers? employees? smt else? 
- `insight 1` : ***Chips 20% increase. Sweets 30% decrease***
  - what was the `problem's contribution` ?
  - only relevant info 
- `insight 2`: ***most popular chocolate 50% decreased***
  - add `supporting evidence`
  - help `better explain` the `cause of problem` 
- `climax` : ***loss 10M next year***
  - `CENTRAL INSIGHT`
  - `what could happend if no change ?` 
- `next steps` : ***rebrand chocolate offering special discounts, can achieve a 20% PROFIT***
  - `potential solutions` 
  - course of `actions`
  - proactive : guidance audience through undertanding what to do if we want impact in decision making process
# 📚 building narrative
...
# Is It a true story?
> You have done an amazing Job explalning your exploratory data analysls on the churn project. Now, its time to
run the model to predict customer churn. You know that you will have to craft an effectlive story to present these
results.
You want to be prepared. So you read your notes on how to bulld a compeliling narratlive. But you realized that
one of your notes Is not accurate.
- Which of the following statement ls false?
- [ ] A compelling narrative Is key to presenting relevant Insights to your target audlence In a meaningful
and Impactful way.
- [ ] Because you should shape the narrative to your target audlence, showing only key polnts or findingsee
Is a good practice.
- [x] Unless you have a great data groundwork to support your central Insight. your indings will need a
well-tormed and compellng narratve to drive actlon and change.
...
- Explain with a line plot that the company usually has a churn rate of 5%, but
last year that rate suddenly Increased to 15%.
- Using boxplots, show that the percentage of churn customers with more than
one dependent In thelr household has Increased, affecting the total rate.
- Add further evidence by showing that a higher percentage of customers wth
more than one dependent In thelr household with DSL service churn.
- Show a barplot that reveals that monthly charges are the most Important
predictor of customer churn.
- Recommend to Implement promotional prices to churn-Intending customers
and show that this will resuit In 10% more earnings with a barplot.

***strong copelling narrative :  This makes it easier to understand and can help to persuade stakeholders to take actions and drive change!***
# A story to compare
> Correctly classify the following examples as comparison, correlation or clustering.
- **Comparison**

  - About 50% of the churning customers are
marrled, while only 30% of the non-churning
customers have dependents.
  - 50% of the churning customers have a pay-
as-you-go contract. While 90% of non-
churning customers are In a 2-year or 3-year
contract

- **Correlation**

  - The number of times a customer that
churned streamed movles Is higher If they
pay higher monthly charges.
  - The monthly charges decrease as the
number of months a non-churning custome
has subscrlbed for Increases.

- **Clustering**

  - There are customers with low monthly
charges and low streaming time and
customers with high monthly charges and
high streaming time.
