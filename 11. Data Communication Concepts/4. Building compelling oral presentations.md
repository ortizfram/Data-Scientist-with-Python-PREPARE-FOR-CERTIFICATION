...
- Best practices
      ...
      - Speak slowily when showing the Importance of Fliber Optlc for predicting
        churn but faster when explalning the urgency to change the Streaming
        TV plan.
      - Asking your audlence If they belleve that the type of phone servlce a
        cllent has Is an Important factor Impacting the customer churn rate.
- Common mistakes

      - Explaining at the end that 20% of customers left with an equal gender
        balance, and that the monthly charge Is a good predictor of churn.
      - Avolding moving your hands or polnting to the screen when showing t
        the company should create a promotional campalgn to retaln Its
        customers.
      - Omitting that you assume that It costs 15% more to attract a custome
        than to retain an exlsting one, so the presentatlon Is not long.
      - Showing a boxplot of the amount of months churning and non-churnir
        customers subscrlbed without relterating that tenure affects customer
        churn.
